...
@Component({
  selector: 'app-map-business-process-page',
  templateUrl: './map-business-process-page.component.html',
  styleUrls: ['./map-business-process-page.component.css']
})
@Injectable()
export class MapBusinessProcessPageComponent implements OnInit {
